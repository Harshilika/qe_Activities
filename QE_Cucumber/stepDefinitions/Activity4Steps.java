...
public class Activity4Steps extends Base{
    ...
    @When("user enters with username {string} and with password {string}")
    ...
    @Then("get confirmation message as {string} and confirms it")
    public void verifyMessage(String text)
    {
        WebElement msg_ele=driver.findElement(By.xpath("/html/body/div/main/div/div/div/div/div/h2"));
